...
def generate_qr_code(ticket):
    ...
    #pesan logger
    logger.debug(f"Isi data qr code: {qr_data}")
    logger.debug(f"Isi data qr code terenkripsi: {encrypted_data}")
